...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Ketan Chopda"
  # spec.authors            = { "Ketan Chopda" => "Ketan.C@simformsolutions.com" }
  # spec.social_media_url   = "https://twitter.com/Ketan Chopda"
